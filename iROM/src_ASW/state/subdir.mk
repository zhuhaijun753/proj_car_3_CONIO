...
CPP_SRCS += \
../src_ASW/state/statemachine.cpp \
../src_ASW/state/statemachine_config.cpp 

OBJS += \
./src_ASW/state/statemachine.o \
./src_ASW/state/statemachine_config.o 

CPP_DEPS += \
./src_ASW/state/statemachine.d \
./src_ASW/state/statemachine_config.d 


# Each subdirectory must supply rules for building sources it contributes
src_ASW/state/%.o: ../src_ASW/state/%.cpp
	@echo 'Building file: $<'
