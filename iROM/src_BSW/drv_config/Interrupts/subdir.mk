...
CPP_SRCS += \
../src_BSW/drv_config/Interrupts/Interrupts_cfg.cpp 

OBJS += \
./src_BSW/drv_config/Interrupts/Interrupts_cfg.o 

CPP_DEPS += \
./src_BSW/drv_config/Interrupts/Interrupts_cfg.d 


# Each subdirectory must supply rules for building sources it contributes
src_BSW/drv_config/Interrupts/%.o: ../src_BSW/drv_config/Interrupts/%.cpp
	@echo 'Building file: $<'
