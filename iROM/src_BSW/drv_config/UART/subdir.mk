...
CPP_SRCS += \
../src_BSW/drv_config/UART/UART_config.cpp 

OBJS += \
./src_BSW/drv_config/UART/UART_config.o 

CPP_DEPS += \
./src_BSW/drv_config/UART/UART_config.d 


# Each subdirectory must supply rules for building sources it contributes
src_BSW/drv_config/UART/%.o: ../src_BSW/drv_config/UART/%.cpp
	@echo 'Building file: $<'
