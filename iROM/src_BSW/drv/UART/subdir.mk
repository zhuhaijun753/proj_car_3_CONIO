...
CPP_SRCS += \
../src_BSW/drv/UART/UART.cpp \
../src_BSW/drv/UART/UARTprot.cpp 

OBJS += \
./src_BSW/drv/UART/UART.o \
./src_BSW/drv/UART/UARTprot.o 

CPP_DEPS += \
./src_BSW/drv/UART/UART.d \
./src_BSW/drv/UART/UARTprot.d 


# Each subdirectory must supply rules for building sources it contributes
src_BSW/drv/UART/%.o: ../src_BSW/drv/UART/%.cpp
	@echo 'Building file: $<'
