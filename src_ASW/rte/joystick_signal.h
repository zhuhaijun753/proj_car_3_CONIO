...
*  file    JOYSTICK.h
*
*  brief   signal base class for signal JOYSTICK
*
 ...
 **/
typedef uint16_t JOYSTICK_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef JOYSTICK_data_t JOYSTICK_value_t;
//typedef 0 JOYSTICK_raw_value_t;
							  
/**
 *  Instances of the struct JOYSTICK_t represent the signal objects.
...
{                                                                                                                      
   ...
   //const JOYSTICK_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   JOYSTICK_cfg_s lnkJOYSTICK_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct JOYSTICK_s SIG_DATA_SIZE_OPTIMIZATION JOYSTICK_t;
#endif                                                                                                                       
 ...
 *
 * @param  JOYSTICK_t * const signal: Pointer to the signal object which will be initialised
 * @param const JOYSTICK_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t JOYSTICK_init(       JOYSTICK_t * const signal
                             , const JOYSTICK_data_t       value )
{                                                                                                                      
 ...
 *
 * @param  JOYSTICK_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t JOYSTICK_get_status( const JOYSTICK_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t JOYSTICK_is_status_invalid( const JOYSTICK_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t JOYSTICK_set_status_invalid( JOYSTICK_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t JOYSTICK_set_status(        JOYSTICK_t * const signal
 ...
 *
 * @param  JOYSTICK_t * const signal: Pointer to the signal object
 * @return JOYSTICK_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE JOYSTICK_time_t JOYSTICK_get_age( const JOYSTICK_t * const signal )
{
   return signal->age;
}
 ...
 * @param  JOYSTICK_t * const signal: Pointer to the signal object
 * @param JOYSTICK_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void JOYSTICK_inc_age(  JOYSTICK_t * const signal , JOYSTICK_time_t increment)
{
 ...
 */
STATIC_INLINE JOYSTICK_time_t JOYSTICK_get_time_remaining( const JOYSTICK_t * const signal, JOYSTICK_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t JOYSTICK_is_new( const JOYSTICK_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (JOYSTICK_time_t)0);
}
 ...
 *
 * @param  JOYSTICK_t * const signal: Pointer to the signal object
 * @return JOYSTICK_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE JOYSTICK_data_t JOYSTICK_get( const JOYSTICK_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  JOYSTICK_t * const signal: Pointer to the signal object
 * @return JOYSTICK_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE JOYSTICK_data_t* const JOYSTICK_get_by_pointer( const JOYSTICK_t * const signal )
{                                                                                                                      
   return (JOYSTICK_data_t* const) &(signal->value);                                                                                               
} 
 ...
 *
 * @param  JOYSTICK_t * const signal: Pointer to the signal object
 * @param  JOYSTICK_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t JOYSTICK_get_with_status( const JOYSTICK_t * const signal
                                           ,       JOYSTICK_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  JOYSTICK_t * const signal: Pointer to the signal object
 * @param  JOYSTICK_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t JOYSTICK_set(       JOYSTICK_t * const signal
                           , const JOYSTICK_data_t value  )
{
...
#define JOYSTICK_CREATE_SIGNAL(																	    \
						 ...
						 , MEMROM)																	\
                                                                                                    \
JOYSTICK_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   SIG_STS_STARTUP,                                                                                 \
   (JOYSTICK_time_t)0,                                                                               \
