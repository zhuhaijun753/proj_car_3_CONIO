...
*  file    SINT32_IR.h
*
*  brief   signal base class for signal SINT32_IR
*
...
#ifndef SINT32_IR_H_INCLUDED
#define SINT32_IR_H_INCLUDED
 ...
 **/
typedef uint16_t SINT32_IR_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef sint32_t SINT32_IR_value_t;
//typedef 0 SINT32_IR_raw_value_t;
							  
/**
 *  Instances of the struct SINT32_IR_t represent the signal objects.
...
{                                                                                                                      
   ...
   //const SINT32_IR_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   SINT32_IR_cfg_s lnkSINT32_IR_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct SINT32_IR_s SIG_DATA_SIZE_OPTIMIZATION SINT32_IR_t;
#endif                                                                                                                       
 ...
 *
 * @param  SINT32_IR_t * const signal: Pointer to the signal object which will be initialised
 * @param const sint32_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t SINT32_IR_init(       SINT32_IR_t * const signal
                             , const sint32_t       value )
{                                                                                                                      
 ...
 *
 * @param  SINT32_IR_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t SINT32_IR_get_status( const SINT32_IR_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t SINT32_IR_is_status_invalid( const SINT32_IR_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t SINT32_IR_set_status_invalid( SINT32_IR_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t SINT32_IR_set_status(        SINT32_IR_t * const signal
 ...
 *
 * @param  SINT32_IR_t * const signal: Pointer to the signal object
 * @return SINT32_IR_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE SINT32_IR_time_t SINT32_IR_get_age( const SINT32_IR_t * const signal )
{
   return signal->age;
}
 ...
 * @param  SINT32_IR_t * const signal: Pointer to the signal object
 * @param SINT32_IR_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void SINT32_IR_inc_age(  SINT32_IR_t * const signal , SINT32_IR_time_t increment)
{
 ...
 */
STATIC_INLINE SINT32_IR_time_t SINT32_IR_get_time_remaining( const SINT32_IR_t * const signal, SINT32_IR_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t SINT32_IR_is_new( const SINT32_IR_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (SINT32_IR_time_t)0);
}
 ...
 *
 * @param  SINT32_IR_t * const signal: Pointer to the signal object
 * @return sint32_t: current value of the application data buffer
 *
 **/
STATIC_INLINE sint32_t SINT32_IR_get( const SINT32_IR_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SINT32_IR_t * const signal: Pointer to the signal object
 * @return sint32_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE sint32_t* const SINT32_IR_get_by_pointer( const SINT32_IR_t * const signal )
{                                                                                                                      
   return (sint32_t* const) &(signal->value);                                                                                               
} 
 ...
 *
 * @param  SINT32_IR_t * const signal: Pointer to the signal object
 * @param  sint32_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t SINT32_IR_get_with_status( const SINT32_IR_t * const signal
                                           ,       sint32_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  SINT32_IR_t * const signal: Pointer to the signal object
 * @param  sint32_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t SINT32_IR_set(       SINT32_IR_t * const signal
                           , const sint32_t value  )
{
...
*
*/
#define SINT32_IR_CREATE_SIGNAL(																	    \
                           SIGNAL_NAME																\
                         , INIT_VALUE                                                               \
                         , INIT_RAW_VALUE                                                           \
                         , SCL_RAW_TO_VAL                                                           \
						 ...
						 , MEMROM)																	\
                                                                                                    \
SINT32_IR_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   SIG_STS_STARTUP,                                                                                 \
   (SINT32_IR_time_t)0,                                                                               \
