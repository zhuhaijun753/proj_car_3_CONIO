 ...
 *
 * @param  ENGINEDECODER_t * const signal: Pointer to the signal object
 * @return ENGINEDECODER_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE ENGINEDECODER_data_t* const ENGINEDECODER_get_by_pointer( const ENGINEDECODER_t * const signal )
{                                                                                                                      
   return (ENGINEDECODER_data_t* const) &(signal->value);                                                                                               
}                                                                                                                       
