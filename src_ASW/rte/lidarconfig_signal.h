...
*  file    LIDARCONFIG.h
*
*  brief   signal base class for signal LIDARCONFIG
*
...
#ifndef LIDARCONFIG_H_INCLUDED
#define LIDARCONFIG_H_INCLUDED
...
*/
//#define SIG_NO_CONV( LIDARCONFIG_data_t )
//STATIC_INLINE LIDARCONFIG_data_t LIDARCONFIG_data_t##_NO_CONV( LIDARCONFIG_data_t val )
//{
//   return val;
//}
 ...
 */
typedef RC_t   (*LIDARCONFIG_scl_to_val_func_t)( const LIDARCONFIG_raw_t * const, LIDARCONFIG_data_t * const);

/**
 * Function pointer type for scaling application data to raw data
 */
typedef RC_t   (*LIDARCONFIG_scl_to_raw_func_t)( const LIDARCONFIG_data_t * const, LIDARCONFIG_raw_t * const);
 ...
 *  I-Port
 */
typedef RC_t       (*LIDARCONFIG_refresh_func_t   )(       LIDARCONFIG_raw_t * const, const SIG_IDX_TYPE );

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t       (*LIDARCONFIG_flush_func_t     )( const LIDARCONFIG_raw_t * const, const SIG_IDX_TYPE );
...
/**
 *  Instances of structure LIDARCONFIG_flush_channel_t represent a flushable driver output channel.
 ...
 */
struct LIDARCONFIG_flush_channel_s
{
	/**
     ...
     */
    LIDARCONFIG_flush_func_t const flush_func;
};                                                                                                                     
typedef SIG_CONST struct LIDARCONFIG_flush_channel_s SIG_CONST_SIZE_OPTIMIZATION LIDARCONFIG_flush_channel_t;
                                                                                                                       
/**
 *  Instances of the structure LIDARCONFIG_cfg_t represent the signal configuration object.
 *
 ...
 * of flushable channels. Flush channels have to be instances of the structure 'LIDARCONFIG_flush_channel_t' (for further
...
struct LIDARCONFIG_cfg_s
{
     ...
     */
    LIDARCONFIG_refresh_func_t const           refresh_func;

    /**
     * Pointer to the output driver table
     */
   const LIDARCONFIG_flush_channel_t * const  p_flush_channel_table;

#ifdef TOGETHER
   /**
    * @link association 
    */
   LIDARCONFIG_scaler lnkLIDARCONFIG_scaler;
   /**@link aggregation*/
   LIDARCONFIG_flush_channel_s lnkLIDARCONFIG_flush_channel_s;
#endif
};                                                                                                                     
typedef SIG_CONST struct LIDARCONFIG_cfg_s SIG_CONST_SIZE_OPTIMIZATION SIG_CFG_SECTION LIDARCONFIG_cfg_t;
 ...
 **/
typedef uint16_t LIDARCONFIG_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef LIDARCONFIG_data_t LIDARCONFIG_value_t;
typedef LIDARCONFIG_raw_t LIDARCONFIG_raw_value_t;
							  
/**
 *  Instances of the struct LIDARCONFIG_t represent the signal objects.
 ...
 */
#ifdef TOGETHER
class LIDARCONFIG_signal
{
	public:
#else
struct LIDARCONFIG_s
{                                                                                                                      
#endif
	 ...
	 */
    LIDARCONFIG_data_t                    value;

    /**
     * Data buffer for the raw value
     */
    LIDARCONFIG_raw_t                    raw_value;
   ...
   const LIDARCONFIG_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   LIDARCONFIG_cfg_s lnkLIDARCONFIG_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct LIDARCONFIG_s SIG_DATA_SIZE_OPTIMIZATION LIDARCONFIG_t;
#endif                                                                                                                       
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object which will be initialised
 * @param const LIDARCONFIG_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_init(       LIDARCONFIG_t * const signal
                             , const LIDARCONFIG_data_t       value )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   const LIDARCONFIG_cfg_t * const p_sig_cfg = signal->p_sig_cfg;

   LIDARCONFIG_raw_t raw_value = signal->raw_value;
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t LIDARCONFIG_get_status( const LIDARCONFIG_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t LIDARCONFIG_is_status_invalid( const LIDARCONFIG_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t LIDARCONFIG_set_status_invalid( LIDARCONFIG_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t LIDARCONFIG_set_status(        LIDARCONFIG_t * const signal
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @return LIDARCONFIG_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE LIDARCONFIG_time_t LIDARCONFIG_get_age( const LIDARCONFIG_t * const signal )
{
   return signal->age;
}
 ...
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param LIDARCONFIG_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void LIDARCONFIG_inc_age(  LIDARCONFIG_t * const signal , LIDARCONFIG_time_t increment)
{
 ...
 */
STATIC_INLINE LIDARCONFIG_time_t LIDARCONFIG_get_time_remaining( const LIDARCONFIG_t * const signal, LIDARCONFIG_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t LIDARCONFIG_is_new( const LIDARCONFIG_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (LIDARCONFIG_time_t)0);
}
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @return LIDARCONFIG_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE LIDARCONFIG_data_t LIDARCONFIG_get( const LIDARCONFIG_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param  LIDARCONFIG_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t LIDARCONFIG_get_with_status( const LIDARCONFIG_t * const signal
                                           ,       LIDARCONFIG_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param  LIDARCONFIG_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_set(       LIDARCONFIG_t * const signal
                           , const LIDARCONFIG_data_t value  )
{
   ...
   //Increment the age
   //LIDARCONFIG_inc_age(signal); //Taken out to support time triggered increment of age
   ...
   signal->age    = (LIDARCONFIG_time_t)0;
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @return LIDARCONFIG_raw_t: current value of the raw data buffer
 */
STATIC_INLINE LIDARCONFIG_raw_t LIDARCONFIG_get_raw( const LIDARCONFIG_t * const signal )
{                                                                                                                      
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param  LIDARCONFIG_raw_t * const raw_value : Pointer for returning the current value of the raw data buffer
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t LIDARCONFIG_get_raw_with_status( const LIDARCONFIG_t * const signal
                                               ,       LIDARCONFIG_raw_t * const raw_value )
{                                                                                                                      
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param const LIDARCONFIG_raw_t raw_value: Raw value which will be stored in the daw data buffer. The application value will be updated afterwards
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t LIDARCONFIG_set_raw(       LIDARCONFIG_t * const signal
                               , const LIDARCONFIG_raw_t         raw_value )
{
   ...
   //LIDARCONFIG_data_t value = signal->value;
 ...
 *
 */
STATIC_INLINE RC_t LIDARCONFIG_refresh( LIDARCONFIG_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {                                                                                                                   
      //LIDARCONFIG_raw_t raw_value  = signal->raw_value; // Todo: Critical section for complex datatypes.
      if ( ! signal->discon_raw_value )
	  {
 ...
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_flush( const LIDARCONFIG_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const LIDARCONFIG_flush_channel_t * p_flush_channel =
                                            (const LIDARCONFIG_flush_channel_t *)(signal->p_sig_cfg->p_flush_channel_table);
         
   if ( ! signal->discon_raw_value )	 
   {
	   // Only flush in case the raw value is not disconnected.
	   
       if ( ! LIDARCONFIG_is_status_invalid( signal ) )
	   {                                                                                                                   
		  ...
		  {                                                                                                                
			 while ( NULL != p_flush_channel->flush_func )                                                                 
			 {
				...
				if ( p_flush_channel->flush_func( (const LIDARCONFIG_raw_t * const)&(signal->raw_value)
 ...
 *
 * @param LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param LIDARCONFIG_data_t * const value: Pointer for returning the application value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_read( LIDARCONFIG_t * const signal
                            ,     LIDARCONFIG_data_t * const value  )
{                                                                                                                      
   RC_t ret = LIDARCONFIG_refresh( signal );
   *value = LIDARCONFIG_get( signal );
   return ret;                                                                                                         
}
 ...
 *
 * @param  LIDARCONFIG_t * const signal: Pointer to the signal object
 * @return LIDARCONFIG_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE LIDARCONFIG_data_t* const LIDARCONFIG_get_by_pointer( const LIDARCONFIG_t * const signal )
{                                                                                                                      
   return (LIDARCONFIG_data_t* const) &(signal->value);                                                                                               
}                                                                                                                       
 ...
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_read_with_status(  LIDARCONFIG_t * const signal
                                     , LIDARCONFIG_data_t * const value
                                     , sig_sts_t* const status    )
{                                                                                                                      
   RC_t ret = LIDARCONFIG_refresh( signal );
   *status   = LIDARCONFIG_get_with_status( signal, value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param LIDARCONFIG_raw_t * const raw_value: Pointer for returning the raw data value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_read_raw( LIDARCONFIG_t * const signal
                                , LIDARCONFIG_raw_t * const raw_value )
{                                                                                                                      
   RC_t ret     = LIDARCONFIG_refresh( signal );
   *raw_value = LIDARCONFIG_get_raw( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_read_raw_with_status(  LIDARCONFIG_t * const signal
                                         ,  LIDARCONFIG_raw_t * const raw_value
                                         , sig_sts_t* const status       )
{                                                                                                                      
   RC_t ret = LIDARCONFIG_refresh( signal );
   *status   = LIDARCONFIG_get_raw_with_status( signal, raw_value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param const LIDARCONFIG_data_t value: The new value for the application data buffer
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t LIDARCONFIG_write(       LIDARCONFIG_t * const signal
                             , const LIDARCONFIG_data_t             value  )
{                                                                                                                      
   RC_t ret = LIDARCONFIG_set( signal, value );
                                                                                                                       
   if ( ret == RC_SUCCESS )                                                                                            
   {                                                                                                                   
      ret = LIDARCONFIG_flush( signal );
   }                                                                                                                   
 ...
 *
 * @param LIDARCONFIG_t * const signal: Pointer to the signal object
 * @param const LIDARCONFIG_raw_t raw_value: new raw value
 * @return  RC_t: Return value of the driver call
 *
 */
STATIC_INLINE RC_t LIDARCONFIG_write_raw(       LIDARCONFIG_t * const signal
                                 , const LIDARCONFIG_raw_t         raw_value )
{                                                                                                                      
   RC_t ret = LIDARCONFIG_set_raw( signal, raw_value );
 ...
 *
 * @param LIDARCONFIG_t * const * const p_signal_list: Pointer to the signal list
 * @return RC_t: RC_SUCCESS if all calls have been successful, RC_ERROR otherwise
 */
STATIC_INLINE RC_t LIDARCONFIG_refresh_all( LIDARCONFIG_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   LIDARCONFIG_t * const * p_elem = (LIDARCONFIG_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {                                                                                                                   
      if ( LIDARCONFIG_refresh( (LIDARCONFIG_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
 ...
 *
 */
STATIC_INLINE RC_t LIDARCONFIG_flush_all( LIDARCONFIG_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const LIDARCONFIG_t * const * p_elem = (const LIDARCONFIG_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {
	   //Todo: add other return code error handling
      if ( LIDARCONFIG_flush( (const LIDARCONFIG_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
...
*
*/
#define LIDARCONFIG_CREATE_SIGNAL(																	    \
                           SIGNAL_NAME																\
                         , INIT_VALUE                                                               \
                         , INIT_RAW_VALUE                                                           \
                         , SCL_RAW_TO_VAL                                                           \
						 ...
						 , MEMROM)																	\
                                                                                                    \
static const LIDARCONFIG_cfg_t SIGNAL_NAME##_cfg __attribute__ ((section ( #MEMROM )))=				    \
{                                                                                                   \
   SCL_RAW_TO_VAL,                                                                                  \
   SCL_VAL_TO_RAW,                                                                                  \
   REFRESH_IDX,                                                                                     \
   ...
   FLUSH_CHANNEL_TABLE                                                                              \
																									...
																									\
LIDARCONFIG_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   INIT_RAW_VALUE,                                                                                  \
   SIG_STS_STARTUP,                                                                                 \
   (LIDARCONFIG_time_t)0,                                                                               \
   FALSE,                                                                                           \
   FALSE,                                                                                           \
   &SIGNAL_NAME##_cfg																				\
};																									\
