...
*  file    UINT8.h
*
*  brief   signal base class for signal UINT8
*
*  author  Peter Fromm       <peter.fromm@h-da.de>
*
*
* Version v5
...
*/
//#define SIG_NO_CONV( uint8_t )
//STATIC_INLINE uint8_t uint8_t##_NO_CONV( uint8_t val )
//{
//   return val;
//}
 ...
 */
typedef RC_t   (*UINT8_scl_to_val_func_t)( const uint8_t * const, uint8_t * const);

/**
 * Function pointer type for scaling application data to raw data
 */
typedef RC_t   (*UINT8_scl_to_raw_func_t)( const uint8_t * const, uint8_t * const);


/**
 * Definition of the default converter raw to application, which will be used, if no explicit scaler is defined
 **/
STATIC_INLINE RC_t UINT8_scl_to_val( const uint8_t * const praw, uint8_t * const pvalue)
{
	*pvalue = (uint8_t) (*praw);
	return RC_SUCCESS;
}
...
/**
 * Definition of the default converter application to raw, which will be used, if no explicit scaler is defined
 **/
STATIC_INLINE RC_t UINT8_scl_to_raw( const uint8_t * const pvalue, uint8_t * const praw)
{
	*praw = (uint8_t) (*pvalue);
	return RC_SUCCESS;
}
 ...
 *  I-Port
 */
typedef RC_t       (*UINT8_refresh_func_t   )(       uint8_t * const, const SIG_IDX_TYPE );

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t       (*UINT8_flush_func_t     )( const uint8_t * const, const SIG_IDX_TYPE );
...
/**
 *  Instances of structure UINT8_flush_channel_t represent a flushable driver output channel.
...
struct UINT8_flush_channel_s
{
     ...
     */
    UINT8_flush_func_t const flush_func;
};                                                                                                                     
typedef SIG_CONST struct UINT8_flush_channel_s SIG_CONST_SIZE_OPTIMIZATION UINT8_flush_channel_t;
                                                                                                                       
/**
 *  Instances of the structure UINT8_cfg_t represent the signal configuration object.
 *
 ...
 * of flushable channels. Flush channels have to be instances of the structure 'UINT8_flush_channel_t' (for further
...
struct UINT8_cfg_s
{
	 ...
	 */
    UINT8_scl_to_val_func_t const        scl_to_val_func;
	/**
	 * Pointer to the d2r scaler. NULL, if class default scaler will be used
	 */
    UINT8_scl_to_raw_func_t const        scl_to_raw_func;
     ...
     */
    UINT8_refresh_func_t const           refresh_func;

    /**
     * Pointer to the output driver table
     */
   const UINT8_flush_channel_t * const  p_flush_channel_table;

#ifdef TOGETHER
   /**
    * @link association 
    */
   UINT8_scaler lnkUINT8_scaler;
   /**@link aggregation*/
   UINT8_flush_channel_s lnkUINT8_flush_channel_s;
#endif
};                                                                                                                     
typedef SIG_CONST struct UINT8_cfg_s SIG_CONST_SIZE_OPTIMIZATION SIG_CFG_SECTION UINT8_cfg_t;
 ...
 **/
typedef uint16_t UINT8_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef uint8_t UINT8_value_t;
typedef uint8_t UINT8_raw_value_t;
							  
/**
 *  Instances of the struct UINT8_t represent the signal objects.
...
{                                                                                                                      
   ...
   const UINT8_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   UINT8_cfg_s lnkUINT8_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct UINT8_s SIG_DATA_SIZE_OPTIMIZATION UINT8_t;
#endif                                                                                                                       
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object which will be initialised
 * @param const uint8_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t UINT8_init(       UINT8_t * const signal
                             , const uint8_t       value )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   const UINT8_cfg_t * const p_sig_cfg = signal->p_sig_cfg;

   uint8_t raw_value = signal->raw_value;
   ...
   if ( NULL == p_sig_cfg->scl_to_raw_func )                                                                           
   {
       ...
       ret  = UINT8_scl_to_raw(&value, &raw_value);
   }                                                                                                                   
   else                                                                                                                
   {                                                                                                                   
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t UINT8_get_status( const UINT8_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t UINT8_is_status_invalid( const UINT8_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t UINT8_set_status_invalid( UINT8_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t UINT8_set_status(        UINT8_t * const signal
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @return UINT8_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE UINT8_time_t UINT8_get_age( const UINT8_t * const signal )
{
   return signal->age;
}
 ...
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @param UINT8_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void UINT8_inc_age(  UINT8_t * const signal , UINT8_time_t increment)
{
 ...
 */
STATIC_INLINE UINT8_time_t UINT8_get_time_remaining( const UINT8_t * const signal, UINT8_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t UINT8_is_new( const UINT8_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (UINT8_time_t)0);
}
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @return uint8_t: current value of the application data buffer
 *
 **/
STATIC_INLINE uint8_t UINT8_get( const UINT8_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @param  uint8_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t UINT8_get_with_status( const UINT8_t * const signal
                                           ,       uint8_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @param  uint8_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t UINT8_set(       UINT8_t * const signal
                           , const uint8_t value  )
{
   ...
   //Increment the age
   //UINT8_inc_age(signal); //Taken out to support time triggered increment of age
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @return uint8_t: current value of the raw data buffer
 */
STATIC_INLINE uint8_t UINT8_get_raw( const UINT8_t * const signal )
{                                                                                                                      
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @param  uint8_t * const raw_value : Pointer for returning the current value of the raw data buffer
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t UINT8_get_raw_with_status( const UINT8_t * const signal
                                               ,       uint8_t * const raw_value )
{                                                                                                                      
 ...
 *
 * @param  UINT8_t * const signal: Pointer to the signal object
 * @param const uint8_t raw_value: Raw value which will be stored in the daw data buffer. The application value will be updated afterwards
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t UINT8_set_raw(       UINT8_t * const signal
                               , const uint8_t         raw_value )
{
   ...
   {
      ret = UINT8_scl_to_val(&raw_value, &value);
   }
   else
   {
 ...
 *
 */
STATIC_INLINE RC_t UINT8_refresh( UINT8_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {                                                                                                                   
      uint8_t raw_value  = signal->raw_value; // Todo: Critical section for complex datatypes.
 ...
 *
 **/
STATIC_INLINE RC_t UINT8_flush( const UINT8_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const UINT8_flush_channel_t * p_flush_channel =
                                            (const UINT8_flush_channel_t *)(signal->p_sig_cfg->p_flush_channel_table);
                                                                                                                       
   if ( ! UINT8_is_status_invalid( signal ) )
   {                                                                                                                   
      ...
      {                                                                                                                
         while ( NULL != p_flush_channel->flush_func )                                                                 
         {
            ...
            if ( p_flush_channel->flush_func( (const uint8_t * const)&(signal->raw_value)
 ...
 *
 * @param UINT8_t * const signal: Pointer to the signal object
 * @param uint8_t * const value: Pointer for returning the application value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t UINT8_read( UINT8_t * const signal
                            ,     uint8_t * const value  )
{                                                                                                                      
   RC_t ret = UINT8_refresh( signal );
   *value = UINT8_get( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t UINT8_read_with_status(  UINT8_t * const signal
                                     , uint8_t * const value
                                     , sig_sts_t* const status    )
{                                                                                                                      
   RC_t ret = UINT8_refresh( signal );
   *status   = UINT8_get_with_status( signal, value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param UINT8_t * const signal: Pointer to the signal object
 * @param uint8_t * const raw_value: Pointer for returning the raw data value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t UINT8_read_raw( UINT8_t * const signal
                                , uint8_t * const raw_value )
{                                                                                                                      
   RC_t ret     = UINT8_refresh( signal );
   *raw_value = UINT8_get_raw( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t UINT8_read_raw_with_status(  UINT8_t * const signal
                                         ,  uint8_t * const raw_value
                                         , sig_sts_t* const status       )
{                                                                                                                      
   RC_t ret = UINT8_refresh( signal );
   *status   = UINT8_get_raw_with_status( signal, raw_value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param UINT8_t * const signal: Pointer to the signal object
 * @param const uint8_t value: The new value for the application data buffer
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t UINT8_write(       UINT8_t * const signal
                             , const uint8_t             value  )
{                                                                                                                      
   RC_t ret = UINT8_set( signal, value );
                                                                                                                       
   if ( ret == RC_SUCCESS )                                                                                            
   {                                                                                                                   
      ret = UINT8_flush( signal );
   }                                                                                                                   
 ...
 *
 * @param UINT8_t * const signal: Pointer to the signal object
 * @param const uint8_t raw_value: new raw value
 * @return  RC_t: Return value of the driver call
 *
 */
STATIC_INLINE RC_t UINT8_write_raw(       UINT8_t * const signal
                                 , const uint8_t         raw_value )
{                                                                                                                      
   RC_t ret = UINT8_set_raw( signal, raw_value );
 ...
 *
 * @param UINT8_t * const * const p_signal_list: Pointer to the signal list
 * @return RC_t: RC_SUCCESS if all calls have been successful, RC_ERROR otherwise
 */
STATIC_INLINE RC_t UINT8_refresh_all( UINT8_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   UINT8_t * const * p_elem = (UINT8_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {                                                                                                                   
      if ( UINT8_refresh( (UINT8_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
 ...
 *
 */
STATIC_INLINE RC_t UINT8_flush_all( UINT8_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const UINT8_t * const * p_elem = (const UINT8_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {
	   //Todo: add other return code error handling
      if ( UINT8_flush( (const UINT8_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
...
#define UINT8_CREATE_SIGNAL(																	    \
						 ...
						 , MEMROM)																	\
                                                                                                    \
static const UINT8_cfg_t SIGNAL_NAME##_cfg __attribute__ ((section ( #MEMROM )))=				    \
{                                                                                                   \
   SCL_RAW_TO_VAL,                                                                                  \
   SCL_VAL_TO_RAW,                                                                                  \
   REFRESH_IDX,                                                                                     \
   ...
   FLUSH_CHANNEL_TABLE                                                                              \
																									...
																									\
UINT8_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   INIT_RAW_VALUE,                                                                                  \
   SIG_STS_STARTUP,                                                                                 \
...
/***********************************************************************************************************************
*                       Copyright 2013, 2014, 2015 Linde Material Handling. All rights reserved.                       *
***********************************************************************************************************************/
