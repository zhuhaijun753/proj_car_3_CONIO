 ...
 *
 * @param  TARGETSPEED_t * const signal: Pointer to the signal object
 * @return TARGETSPEED_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE TARGETSPEED_data_t* const TARGETSPEED_get_by_pointer( const TARGETSPEED_t * const signal )
{                                                                                                                      
   return (TARGETSPEED_data_t* const) &(signal->value);                                                                                               
}                                                                                                                       
