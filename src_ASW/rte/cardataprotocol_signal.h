/**
*  file    CARDATAPROTOCOL.h
*
*  brief   signal base class for signal CARDATAPROTOCOL
*
...
#ifndef CARDATAPROTOCOL_H_INCLUDED
#define CARDATAPROTOCOL_H_INCLUDED
...
*/
//#define SIG_NO_CONV( CARDATAPROTOCOL_data_t )
//STATIC_INLINE CARDATAPROTOCOL_data_t CARDATAPROTOCOL_data_t##_NO_CONV( CARDATAPROTOCOL_data_t val )
//{
//   return val;
//}
 ...
 */
typedef RC_t   (*CARDATAPROTOCOL_scl_to_val_func_t)( const CARDATAPROTOCOL_raw_t * const, CARDATAPROTOCOL_data_t * const);

/**
 * Function pointer type for scaling application data to raw data
 */
typedef RC_t   (*CARDATAPROTOCOL_scl_to_raw_func_t)( const CARDATAPROTOCOL_data_t * const, CARDATAPROTOCOL_raw_t * const);
 ...
 *  I-Port
 */
typedef RC_t       (*CARDATAPROTOCOL_refresh_func_t   )(       CARDATAPROTOCOL_raw_t * const, const SIG_IDX_TYPE );

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t       (*CARDATAPROTOCOL_flush_func_t     )( const CARDATAPROTOCOL_raw_t * const, const SIG_IDX_TYPE );
...
/**
 *  Instances of structure CARDATAPROTOCOL_flush_channel_t represent a flushable driver output channel.
 ...
 */
struct CARDATAPROTOCOL_flush_channel_s
{
	/**
     ...
     */
    CARDATAPROTOCOL_flush_func_t const flush_func;
};                                                                                                                     
typedef SIG_CONST struct CARDATAPROTOCOL_flush_channel_s SIG_CONST_SIZE_OPTIMIZATION CARDATAPROTOCOL_flush_channel_t;
                                                                                                                       
/**
 *  Instances of the structure CARDATAPROTOCOL_cfg_t represent the signal configuration object.
 *
 ...
 * of flushable channels. Flush channels have to be instances of the structure 'CARDATAPROTOCOL_flush_channel_t' (for further
...
struct CARDATAPROTOCOL_cfg_s
{
	/**
	 * Pointer to the r2d scaler. NULL, if class default scaler will be used
	 */
    CARDATAPROTOCOL_scl_to_val_func_t const        scl_to_val_func;
	/**
	 * Pointer to the d2r scaler. NULL, if class default scaler will be used
	 */
    CARDATAPROTOCOL_scl_to_raw_func_t const        scl_to_raw_func;
     ...
     */
    CARDATAPROTOCOL_refresh_func_t const           refresh_func;

    /**
     * Pointer to the output driver table
     */
   const CARDATAPROTOCOL_flush_channel_t * const  p_flush_channel_table;

#ifdef TOGETHER
   /**
    * @link association 
    */
   CARDATAPROTOCOL_scaler lnkCARDATAPROTOCOL_scaler;
   /**@link aggregation*/
   CARDATAPROTOCOL_flush_channel_s lnkCARDATAPROTOCOL_flush_channel_s;
#endif
};                                                                                                                     
typedef SIG_CONST struct CARDATAPROTOCOL_cfg_s SIG_CONST_SIZE_OPTIMIZATION SIG_CFG_SECTION CARDATAPROTOCOL_cfg_t;
 ...
 **/
typedef uint16_t CARDATAPROTOCOL_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef CARDATAPROTOCOL_data_t CARDATAPROTOCOL_value_t;
typedef CARDATAPROTOCOL_raw_t CARDATAPROTOCOL_raw_value_t;
							  
/**
 *  Instances of the struct CARDATAPROTOCOL_t represent the signal objects.
 ...
 */
#ifdef TOGETHER
class CARDATAPROTOCOL_signal
{
	public:
#else
struct CARDATAPROTOCOL_s
{                                                                                                                      
#endif
	 ...
	 */
    CARDATAPROTOCOL_data_t                    value;

    /**
     * Data buffer for the raw value
     */
    CARDATAPROTOCOL_raw_t                    raw_value;
   ...
   const CARDATAPROTOCOL_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   CARDATAPROTOCOL_cfg_s lnkCARDATAPROTOCOL_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct CARDATAPROTOCOL_s SIG_DATA_SIZE_OPTIMIZATION CARDATAPROTOCOL_t;
#endif                                                                                                                       
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object which will be initialised
 * @param const CARDATAPROTOCOL_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_init(       CARDATAPROTOCOL_t * const signal
                             , const CARDATAPROTOCOL_data_t       value )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   const CARDATAPROTOCOL_cfg_t * const p_sig_cfg = signal->p_sig_cfg;

   CARDATAPROTOCOL_raw_t raw_value = signal->raw_value;
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t CARDATAPROTOCOL_get_status( const CARDATAPROTOCOL_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t CARDATAPROTOCOL_is_status_invalid( const CARDATAPROTOCOL_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t CARDATAPROTOCOL_set_status_invalid( CARDATAPROTOCOL_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t CARDATAPROTOCOL_set_status(        CARDATAPROTOCOL_t * const signal
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @return CARDATAPROTOCOL_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE CARDATAPROTOCOL_time_t CARDATAPROTOCOL_get_age( const CARDATAPROTOCOL_t * const signal )
{
   return signal->age;
}
 ...
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param CARDATAPROTOCOL_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void CARDATAPROTOCOL_inc_age(  CARDATAPROTOCOL_t * const signal , CARDATAPROTOCOL_time_t increment)
{
 ...
 */
STATIC_INLINE CARDATAPROTOCOL_time_t CARDATAPROTOCOL_get_time_remaining( const CARDATAPROTOCOL_t * const signal, CARDATAPROTOCOL_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t CARDATAPROTOCOL_is_new( const CARDATAPROTOCOL_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (CARDATAPROTOCOL_time_t)0);
}
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @return CARDATAPROTOCOL_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE CARDATAPROTOCOL_data_t CARDATAPROTOCOL_get( const CARDATAPROTOCOL_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param  CARDATAPROTOCOL_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t CARDATAPROTOCOL_get_with_status( const CARDATAPROTOCOL_t * const signal
                                           ,       CARDATAPROTOCOL_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param  CARDATAPROTOCOL_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_set(       CARDATAPROTOCOL_t * const signal
                           , const CARDATAPROTOCOL_data_t value  )
{
   ...
   //Increment the age
   //CARDATAPROTOCOL_inc_age(signal); //Taken out to support time triggered increment of age
   ...
   signal->age    = (CARDATAPROTOCOL_time_t)0;
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @return CARDATAPROTOCOL_raw_t: current value of the raw data buffer
 */
STATIC_INLINE CARDATAPROTOCOL_raw_t CARDATAPROTOCOL_get_raw( const CARDATAPROTOCOL_t * const signal )
{                                                                                                                      
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param  CARDATAPROTOCOL_raw_t * const raw_value : Pointer for returning the current value of the raw data buffer
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t CARDATAPROTOCOL_get_raw_with_status( const CARDATAPROTOCOL_t * const signal
                                               ,       CARDATAPROTOCOL_raw_t * const raw_value )
{                                                                                                                      
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param const CARDATAPROTOCOL_raw_t raw_value: Raw value which will be stored in the daw data buffer. The application value will be updated afterwards
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t CARDATAPROTOCOL_set_raw(       CARDATAPROTOCOL_t * const signal
                               , const CARDATAPROTOCOL_raw_t         raw_value )
{
   ...
   //CARDATAPROTOCOL_data_t value = signal->value;
 ...
 *
 */
STATIC_INLINE RC_t CARDATAPROTOCOL_refresh( CARDATAPROTOCOL_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {                                                                                                                   
      //CARDATAPROTOCOL_raw_t raw_value  = signal->raw_value; // Todo: Critical section for complex datatypes.
      if ( ! signal->discon_raw_value )
	  {
 ...
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_flush( const CARDATAPROTOCOL_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const CARDATAPROTOCOL_flush_channel_t * p_flush_channel =
                                            (const CARDATAPROTOCOL_flush_channel_t *)(signal->p_sig_cfg->p_flush_channel_table);
         
   if ( ! signal->discon_raw_value )	 
   {
	   // Only flush in case the raw value is not disconnected.
	   
       if ( ! CARDATAPROTOCOL_is_status_invalid( signal ) )
	   {                                                                                                                   
		  ...
		  {                                                                                                                
			 while ( NULL != p_flush_channel->flush_func )                                                                 
			 {
				...
				if ( p_flush_channel->flush_func( (const CARDATAPROTOCOL_raw_t * const)&(signal->raw_value)
 ...
 *
 * @param CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param CARDATAPROTOCOL_data_t * const value: Pointer for returning the application value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_read( CARDATAPROTOCOL_t * const signal
                            ,     CARDATAPROTOCOL_data_t * const value  )
{                                                                                                                      
   RC_t ret = CARDATAPROTOCOL_refresh( signal );
   *value = CARDATAPROTOCOL_get( signal );
   return ret;                                                                                                         
}
 ...
 *
 * @param  CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @return CARDATAPROTOCOL_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE CARDATAPROTOCOL_data_t* const CARDATAPROTOCOL_get_by_pointer( const CARDATAPROTOCOL_t * const signal )
{                                                                                                                      
   return (CARDATAPROTOCOL_data_t* const) &(signal->value);                                                                                               
}                                                                                                                       
 ...
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_read_with_status(  CARDATAPROTOCOL_t * const signal
                                     , CARDATAPROTOCOL_data_t * const value
                                     , sig_sts_t* const status    )
{                                                                                                                      
   RC_t ret = CARDATAPROTOCOL_refresh( signal );
   *status   = CARDATAPROTOCOL_get_with_status( signal, value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param CARDATAPROTOCOL_raw_t * const raw_value: Pointer for returning the raw data value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_read_raw( CARDATAPROTOCOL_t * const signal
                                , CARDATAPROTOCOL_raw_t * const raw_value )
{                                                                                                                      
   RC_t ret     = CARDATAPROTOCOL_refresh( signal );
   *raw_value = CARDATAPROTOCOL_get_raw( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_read_raw_with_status(  CARDATAPROTOCOL_t * const signal
                                         ,  CARDATAPROTOCOL_raw_t * const raw_value
                                         , sig_sts_t* const status       )
{                                                                                                                      
   RC_t ret = CARDATAPROTOCOL_refresh( signal );
   *status   = CARDATAPROTOCOL_get_raw_with_status( signal, raw_value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param const CARDATAPROTOCOL_data_t value: The new value for the application data buffer
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t CARDATAPROTOCOL_write(       CARDATAPROTOCOL_t * const signal
                             , const CARDATAPROTOCOL_data_t             value  )
{                                                                                                                      
   RC_t ret = CARDATAPROTOCOL_set( signal, value );
                                                                                                                       
   if ( ret == RC_SUCCESS )                                                                                            
   {                                                                                                                   
      ret = CARDATAPROTOCOL_flush( signal );
   }                                                                                                                   
 ...
 *
 * @param CARDATAPROTOCOL_t * const signal: Pointer to the signal object
 * @param const CARDATAPROTOCOL_raw_t raw_value: new raw value
 * @return  RC_t: Return value of the driver call
 *
 */
STATIC_INLINE RC_t CARDATAPROTOCOL_write_raw(       CARDATAPROTOCOL_t * const signal
                                 , const CARDATAPROTOCOL_raw_t         raw_value )
{                                                                                                                      
   RC_t ret = CARDATAPROTOCOL_set_raw( signal, raw_value );
 ...
 *
 * @param CARDATAPROTOCOL_t * const * const p_signal_list: Pointer to the signal list
 * @return RC_t: RC_SUCCESS if all calls have been successful, RC_ERROR otherwise
 */
STATIC_INLINE RC_t CARDATAPROTOCOL_refresh_all( CARDATAPROTOCOL_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   CARDATAPROTOCOL_t * const * p_elem = (CARDATAPROTOCOL_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {                                                                                                                   
      if ( CARDATAPROTOCOL_refresh( (CARDATAPROTOCOL_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
 ...
 *
 */
STATIC_INLINE RC_t CARDATAPROTOCOL_flush_all( CARDATAPROTOCOL_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const CARDATAPROTOCOL_t * const * p_elem = (const CARDATAPROTOCOL_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {
	   //Todo: add other return code error handling
      if ( CARDATAPROTOCOL_flush( (const CARDATAPROTOCOL_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
...
*
*/
#define CARDATAPROTOCOL_CREATE_SIGNAL(																	    \
                           SIGNAL_NAME																\
                         , INIT_VALUE                                                               \
                         , INIT_RAW_VALUE                                                           \
                         , SCL_RAW_TO_VAL                                                           \
						 ...
						 , MEMROM)																	\
                                                                                                    \
static const CARDATAPROTOCOL_cfg_t SIGNAL_NAME##_cfg __attribute__ ((section ( #MEMROM )))=				    \
{                                                                                                   \
   SCL_RAW_TO_VAL,                                                                                  \
   SCL_VAL_TO_RAW,                                                                                  \
   REFRESH_IDX,                                                                                     \
   ...
   FLUSH_CHANNEL_TABLE                                                                              \
																									...
																									\
CARDATAPROTOCOL_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   INIT_RAW_VALUE,                                                                                  \
   SIG_STS_STARTUP,                                                                                 \
   (CARDATAPROTOCOL_time_t)0,                                                                               \
   FALSE,                                                                                           \
   FALSE,                                                                                           \
   &SIGNAL_NAME##_cfg																				\
};																									\
