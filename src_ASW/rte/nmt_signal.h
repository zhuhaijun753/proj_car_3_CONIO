...
*  file    NMT.h
*
*  brief   signal base class for signal NMT
*
...
#ifndef NMT_H_INCLUDED
#define NMT_H_INCLUDED
...
*/
//#define SIG_NO_CONV( NMT_data_t )
//STATIC_INLINE NMT_data_t NMT_data_t##_NO_CONV( NMT_data_t val )
//{
//   return val;
//}
 ...
 */
typedef RC_t   (*NMT_scl_to_val_func_t)( const NMT_raw_t * const, NMT_data_t * const);

/**
 * Function pointer type for scaling application data to raw data
 */
typedef RC_t   (*NMT_scl_to_raw_func_t)( const NMT_data_t * const, NMT_raw_t * const);
 ...
 *  I-Port
 */
typedef RC_t       (*NMT_refresh_func_t   )(       NMT_raw_t * const, const SIG_IDX_TYPE );

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t       (*NMT_flush_func_t     )( const NMT_raw_t * const, const SIG_IDX_TYPE );
...
/**
 *  Instances of structure NMT_flush_channel_t represent a flushable driver output channel.
...
struct NMT_flush_channel_s
{
     ...
     */
    NMT_flush_func_t const flush_func;
};                                                                                                                     
typedef SIG_CONST struct NMT_flush_channel_s SIG_CONST_SIZE_OPTIMIZATION NMT_flush_channel_t;
                                                                                                                       
/**
 *  Instances of the structure NMT_cfg_t represent the signal configuration object.
 *
 ...
 * of flushable channels. Flush channels have to be instances of the structure 'NMT_flush_channel_t' (for further
...
struct NMT_cfg_s
{
	 ...
	 */
    NMT_scl_to_val_func_t const        scl_to_val_func;
	/**
	 * Pointer to the d2r scaler. NULL, if class default scaler will be used
	 */
    NMT_scl_to_raw_func_t const        scl_to_raw_func;
     ...
     */
    NMT_refresh_func_t const           refresh_func;

    /**
     * Pointer to the output driver table
     */
   const NMT_flush_channel_t * const  p_flush_channel_table;

#ifdef TOGETHER
   /**
    * @link association 
    */
   NMT_scaler lnkNMT_scaler;
   /**@link aggregation*/
   NMT_flush_channel_s lnkNMT_flush_channel_s;
#endif
};                                                                                                                     
typedef SIG_CONST struct NMT_cfg_s SIG_CONST_SIZE_OPTIMIZATION SIG_CFG_SECTION NMT_cfg_t;
 ...
 **/
typedef uint16_t NMT_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef NMT_data_t NMT_value_t;
typedef NMT_raw_t NMT_raw_value_t;
							  
/**
 *  Instances of the struct NMT_t represent the signal objects.
...
{                                                                                                                      
   ...
   const NMT_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   NMT_cfg_s lnkNMT_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct NMT_s SIG_DATA_SIZE_OPTIMIZATION NMT_t;
#endif                                                                                                                       
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object which will be initialised
 * @param const NMT_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t NMT_init(       NMT_t * const signal
                             , const NMT_data_t       value )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   const NMT_cfg_t * const p_sig_cfg = signal->p_sig_cfg;

   NMT_raw_t raw_value = signal->raw_value;
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t NMT_get_status( const NMT_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t NMT_is_status_invalid( const NMT_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t NMT_set_status_invalid( NMT_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t NMT_set_status(        NMT_t * const signal
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @return NMT_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE NMT_time_t NMT_get_age( const NMT_t * const signal )
{
   return signal->age;
}
 ...
 * @param  NMT_t * const signal: Pointer to the signal object
 * @param NMT_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void NMT_inc_age(  NMT_t * const signal , NMT_time_t increment)
{
 ...
 */
STATIC_INLINE NMT_time_t NMT_get_time_remaining( const NMT_t * const signal, NMT_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t NMT_is_new( const NMT_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (NMT_time_t)0);
}
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @return NMT_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE NMT_data_t NMT_get( const NMT_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @param  NMT_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t NMT_get_with_status( const NMT_t * const signal
                                           ,       NMT_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @param  NMT_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t NMT_set(       NMT_t * const signal
                           , const NMT_data_t value  )
{
   ...
   //Increment the age
   //NMT_inc_age(signal); //Taken out to support time triggered increment of age
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @return NMT_raw_t: current value of the raw data buffer
 */
STATIC_INLINE NMT_raw_t NMT_get_raw( const NMT_t * const signal )
{                                                                                                                      
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @param  NMT_raw_t * const raw_value : Pointer for returning the current value of the raw data buffer
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t NMT_get_raw_with_status( const NMT_t * const signal
                                               ,       NMT_raw_t * const raw_value )
{                                                                                                                      
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @param const NMT_raw_t raw_value: Raw value which will be stored in the daw data buffer. The application value will be updated afterwards
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t NMT_set_raw(       NMT_t * const signal
                               , const NMT_raw_t         raw_value )
{
 ...
 *
 */
STATIC_INLINE RC_t NMT_refresh( NMT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {                                                                                                                   
      //NMT_raw_t raw_value  = signal->raw_value; // Todo: Critical section for complex datatypes.
      if ( ! signal->discon_raw_value )
	  {
 ...
 *
 **/
STATIC_INLINE RC_t NMT_flush( const NMT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const NMT_flush_channel_t * p_flush_channel =
                                            (const NMT_flush_channel_t *)(signal->p_sig_cfg->p_flush_channel_table);
         
   if ( ! signal->discon_raw_value )	 
   {
	   // Only flush in case the raw value is not disconnected.
	   
       if ( ! NMT_is_status_invalid( signal ) )
	   {                                                                                                                   
		  ...
		  {                                                                                                                
			 while ( NULL != p_flush_channel->flush_func )                                                                 
			 {
				...
				if ( p_flush_channel->flush_func( (const NMT_raw_t * const)&(signal->raw_value)
 ...
 *
 * @param NMT_t * const signal: Pointer to the signal object
 * @param NMT_data_t * const value: Pointer for returning the application value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t NMT_read( NMT_t * const signal
                            ,     NMT_data_t * const value  )
{                                                                                                                      
   RC_t ret = NMT_refresh( signal );
   *value = NMT_get( signal );
   return ret;                                                                                                         
}
 ...
 *
 * @param  NMT_t * const signal: Pointer to the signal object
 * @return NMT_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE NMT_data_t* const NMT_get_by_pointer( const NMT_t * const signal )
{                                                                                                                      
   return (NMT_data_t* const) &(signal->value);                                                                                               
}                                                                                                                       
 ...
 *
 **/
STATIC_INLINE RC_t NMT_read_with_status(  NMT_t * const signal
                                     , NMT_data_t * const value
                                     , sig_sts_t* const status    )
{                                                                                                                      
   RC_t ret = NMT_refresh( signal );
   *status   = NMT_get_with_status( signal, value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param NMT_t * const signal: Pointer to the signal object
 * @param NMT_raw_t * const raw_value: Pointer for returning the raw data value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t NMT_read_raw( NMT_t * const signal
                                , NMT_raw_t * const raw_value )
{                                                                                                                      
   RC_t ret     = NMT_refresh( signal );
   *raw_value = NMT_get_raw( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t NMT_read_raw_with_status(  NMT_t * const signal
                                         ,  NMT_raw_t * const raw_value
                                         , sig_sts_t* const status       )
{                                                                                                                      
   RC_t ret = NMT_refresh( signal );
   *status   = NMT_get_raw_with_status( signal, raw_value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param NMT_t * const signal: Pointer to the signal object
 * @param const NMT_data_t value: The new value for the application data buffer
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t NMT_write(       NMT_t * const signal
                             , const NMT_data_t             value  )
{                                                                                                                      
   RC_t ret = NMT_set( signal, value );
                                                                                                                       
   if ( ret == RC_SUCCESS )                                                                                            
   {                                                                                                                   
      ret = NMT_flush( signal );
   }                                                                                                                   
 ...
 *
 * @param NMT_t * const signal: Pointer to the signal object
 * @param const NMT_raw_t raw_value: new raw value
 * @return  RC_t: Return value of the driver call
 *
 */
STATIC_INLINE RC_t NMT_write_raw(       NMT_t * const signal
                                 , const NMT_raw_t         raw_value )
{                                                                                                                      
   RC_t ret = NMT_set_raw( signal, raw_value );
 ...
 *
 * @param NMT_t * const * const p_signal_list: Pointer to the signal list
 * @return RC_t: RC_SUCCESS if all calls have been successful, RC_ERROR otherwise
 */
STATIC_INLINE RC_t NMT_refresh_all( NMT_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   NMT_t * const * p_elem = (NMT_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {                                                                                                                   
      if ( NMT_refresh( (NMT_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
 ...
 *
 */
STATIC_INLINE RC_t NMT_flush_all( NMT_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const NMT_t * const * p_elem = (const NMT_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {
	   //Todo: add other return code error handling
      if ( NMT_flush( (const NMT_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
...
#define NMT_CREATE_SIGNAL(																	    \
						 ...
						 , MEMROM)																	\
                                                                                                    \
static const NMT_cfg_t SIGNAL_NAME##_cfg __attribute__ ((section ( #MEMROM )))=				    \
{                                                                                                   \
   SCL_RAW_TO_VAL,                                                                                  \
   SCL_VAL_TO_RAW,                                                                                  \
   REFRESH_IDX,                                                                                     \
   ...
   FLUSH_CHANNEL_TABLE                                                                              \
																									...
																									\
NMT_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   INIT_RAW_VALUE,                                                                                  \
   SIG_STS_STARTUP,                                                                                 \
