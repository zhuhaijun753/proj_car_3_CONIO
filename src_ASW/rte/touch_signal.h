...
*  file    TOUCH.h
*
*  brief   signal base class for signal TOUCH
*
 ...
 */
typedef TOUCH_data_t TOUCH_value_t;
//typedef TOUCH_raw_t TOUCH_raw_value_t;
							  
/**
 *  Instances of the struct TOUCH_t represent the signal objects.
...
{                                                                                                                      
   ...
   //const TOUCH_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   TOUCH_cfg_s lnkTOUCH_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct TOUCH_s SIG_DATA_SIZE_OPTIMIZATION TOUCH_t;
#endif                                                                                                                       
 ...
 *
 * @param  TOUCH_t * const signal: Pointer to the signal object which will be initialised
 * @param const TOUCH_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t TOUCH_init(       TOUCH_t * const signal
                             , const TOUCH_data_t       value )
{                                                                                                                      
 ...
 *
 * @param  TOUCH_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t TOUCH_get_status( const TOUCH_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t TOUCH_is_status_invalid( const TOUCH_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t TOUCH_set_status_invalid( TOUCH_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t TOUCH_set_status(        TOUCH_t * const signal
 ...
 *
 * @param  TOUCH_t * const signal: Pointer to the signal object
 * @return TOUCH_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE TOUCH_time_t TOUCH_get_age( const TOUCH_t * const signal )
{
   return signal->age;
}
 ...
 * @param  TOUCH_t * const signal: Pointer to the signal object
 * @param TOUCH_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void TOUCH_inc_age(  TOUCH_t * const signal , TOUCH_time_t increment)
{
 ...
 */
STATIC_INLINE TOUCH_time_t TOUCH_get_time_remaining( const TOUCH_t * const signal, TOUCH_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t TOUCH_is_new( const TOUCH_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (TOUCH_time_t)0);
}
 ...
 *
 * @param  TOUCH_t * const signal: Pointer to the signal object
 * @return TOUCH_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE TOUCH_data_t TOUCH_get( const TOUCH_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  TOUCH_t * const signal: Pointer to the signal object
 * @return TOUCH_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE TOUCH_data_t* const TOUCH_get_by_pointer( const TOUCH_t * const signal )
{                                                                                                                      
   return (TOUCH_data_t* const) &(signal->value);                                                                                               
} 
 ...
 *
 * @param  TOUCH_t * const signal: Pointer to the signal object
 * @param  TOUCH_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t TOUCH_get_with_status( const TOUCH_t * const signal
                                           ,       TOUCH_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  TOUCH_t * const signal: Pointer to the signal object
 * @param  TOUCH_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t TOUCH_set(       TOUCH_t * const signal
                           , const TOUCH_data_t value  )
{
...
#define TOUCH_CREATE_SIGNAL(																	    \
						 ...
						 , MEMROM)																	\
                                                                                                    \
TOUCH_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   SIG_STS_STARTUP,                                                                                 \
   (TOUCH_time_t)0,                                                                               \
