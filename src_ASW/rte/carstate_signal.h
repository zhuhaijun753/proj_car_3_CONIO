...
*  file    CARSTATE.h
*
*  brief   signal base class for signal CARSTATE
*
...
#ifndef CARSTATE_H_INCLUDED
#define CARSTATE_H_INCLUDED
 ...
 **/
typedef uint16_t CARSTATE_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef CARSTATE_data_t CARSTATE_value_t;
//typedef 0 CARSTATE_raw_value_t;
							  
/**
 *  Instances of the struct CARSTATE_t represent the signal objects.
...
{                                                                                                                      
   ...
   //const CARSTATE_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   CARSTATE_cfg_s lnkCARSTATE_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct CARSTATE_s SIG_DATA_SIZE_OPTIMIZATION CARSTATE_t;
#endif                                                                                                                       
 ...
 *
 * @param  CARSTATE_t * const signal: Pointer to the signal object which will be initialised
 * @param const CARSTATE_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t CARSTATE_init(       CARSTATE_t * const signal
                             , const CARSTATE_data_t       value )
{                                                                                                                      
 ...
 *
 * @param  CARSTATE_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t CARSTATE_get_status( const CARSTATE_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t CARSTATE_is_status_invalid( const CARSTATE_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t CARSTATE_set_status_invalid( CARSTATE_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t CARSTATE_set_status(        CARSTATE_t * const signal
 ...
 *
 * @param  CARSTATE_t * const signal: Pointer to the signal object
 * @return CARSTATE_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE CARSTATE_time_t CARSTATE_get_age( const CARSTATE_t * const signal )
{
   return signal->age;
}
 ...
 * @param  CARSTATE_t * const signal: Pointer to the signal object
 * @param CARSTATE_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void CARSTATE_inc_age(  CARSTATE_t * const signal , CARSTATE_time_t increment)
{
 ...
 */
STATIC_INLINE CARSTATE_time_t CARSTATE_get_time_remaining( const CARSTATE_t * const signal, CARSTATE_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t CARSTATE_is_new( const CARSTATE_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (CARSTATE_time_t)0);
}
 ...
 *
 * @param  CARSTATE_t * const signal: Pointer to the signal object
 * @return CARSTATE_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE CARSTATE_data_t CARSTATE_get( const CARSTATE_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  CARSTATE_t * const signal: Pointer to the signal object
 * @return CARSTATE_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE CARSTATE_data_t* const CARSTATE_get_by_pointer( const CARSTATE_t * const signal )
{                                                                                                                      
   return (CARSTATE_data_t* const) &(signal->value);                                                                                               
} 
 ...
 *
 * @param  CARSTATE_t * const signal: Pointer to the signal object
 * @param  CARSTATE_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t CARSTATE_get_with_status( const CARSTATE_t * const signal
                                           ,       CARSTATE_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  CARSTATE_t * const signal: Pointer to the signal object
 * @param  CARSTATE_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t CARSTATE_set(       CARSTATE_t * const signal
                           , const CARSTATE_data_t value  )
{
...
#define CARSTATE_CREATE_SIGNAL(																	    \
						 ...
						 , MEMROM)																	\
                                                                                                    \
CARSTATE_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   SIG_STS_STARTUP,                                                                                 \
   (CARSTATE_time_t)0,                                                                               \
