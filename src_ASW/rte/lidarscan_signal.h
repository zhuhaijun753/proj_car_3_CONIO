...
*  file    LIDARSCAN.h
*
*  brief   signal base class for signal LIDARSCAN
*
...
#ifndef LIDARSCAN_H_INCLUDED
#define LIDARSCAN_H_INCLUDED
...
*/
//#define SIG_NO_CONV( LIDARSCAN_data_t )
//STATIC_INLINE LIDARSCAN_data_t LIDARSCAN_data_t##_NO_CONV( LIDARSCAN_data_t val )
//{
//   return val;
//}
 ...
 */
typedef RC_t   (*LIDARSCAN_scl_to_val_func_t)( const LIDARSCAN_raw_t * const, LIDARSCAN_data_t * const);

/**
 * Function pointer type for scaling application data to raw data
 */
typedef RC_t   (*LIDARSCAN_scl_to_raw_func_t)( const LIDARSCAN_data_t * const, LIDARSCAN_raw_t * const);
 ...
 *  I-Port
 */
typedef RC_t       (*LIDARSCAN_refresh_func_t   )(       LIDARSCAN_raw_t * const, const SIG_IDX_TYPE );

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t       (*LIDARSCAN_flush_func_t     )( const LIDARSCAN_raw_t * const, const SIG_IDX_TYPE );
...
/**
 *  Instances of structure LIDARSCAN_flush_channel_t represent a flushable driver output channel.
 ...
 */
struct LIDARSCAN_flush_channel_s
{
	/**
     ...
     */
    LIDARSCAN_flush_func_t const flush_func;
};                                                                                                                     
typedef SIG_CONST struct LIDARSCAN_flush_channel_s SIG_CONST_SIZE_OPTIMIZATION LIDARSCAN_flush_channel_t;
                                                                                                                       
/**
 *  Instances of the structure LIDARSCAN_cfg_t represent the signal configuration object.
 *
 ...
 * of flushable channels. Flush channels have to be instances of the structure 'LIDARSCAN_flush_channel_t' (for further
...
struct LIDARSCAN_cfg_s
{
     ...
     */
    LIDARSCAN_refresh_func_t const           refresh_func;

    /**
     * Pointer to the output driver table
     */
   const LIDARSCAN_flush_channel_t * const  p_flush_channel_table;

#ifdef TOGETHER
   /**
    * @link association 
    */
   LIDARSCAN_scaler lnkLIDARSCAN_scaler;
   /**@link aggregation*/
   LIDARSCAN_flush_channel_s lnkLIDARSCAN_flush_channel_s;
#endif
};                                                                                                                     
typedef SIG_CONST struct LIDARSCAN_cfg_s SIG_CONST_SIZE_OPTIMIZATION SIG_CFG_SECTION LIDARSCAN_cfg_t;
 ...
 **/
typedef uint16_t LIDARSCAN_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef LIDARSCAN_data_t LIDARSCAN_value_t;
typedef LIDARSCAN_raw_t LIDARSCAN_raw_value_t;
							  
/**
 *  Instances of the struct LIDARSCAN_t represent the signal objects.
...
{                                                                                                                      
	 ...
	 */
    LIDARSCAN_data_t                    value;

    /**
     * Data buffer for the raw value
     */
    LIDARSCAN_raw_t                    raw_value;
   ...
   const LIDARSCAN_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   LIDARSCAN_cfg_s lnkLIDARSCAN_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct LIDARSCAN_s SIG_DATA_SIZE_OPTIMIZATION LIDARSCAN_t;
#endif                                                                                                                       
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object which will be initialised
 * @param const LIDARSCAN_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_init(       LIDARSCAN_t * const signal
                             , const LIDARSCAN_data_t       value )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   const LIDARSCAN_cfg_t * const p_sig_cfg = signal->p_sig_cfg;

   LIDARSCAN_raw_t raw_value = signal->raw_value;
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t LIDARSCAN_get_status( const LIDARSCAN_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t LIDARSCAN_is_status_invalid( const LIDARSCAN_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t LIDARSCAN_set_status_invalid( LIDARSCAN_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t LIDARSCAN_set_status(        LIDARSCAN_t * const signal
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @return LIDARSCAN_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE LIDARSCAN_time_t LIDARSCAN_get_age( const LIDARSCAN_t * const signal )
{
   return signal->age;
}
 ...
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @param LIDARSCAN_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void LIDARSCAN_inc_age(  LIDARSCAN_t * const signal , LIDARSCAN_time_t increment)
{
 ...
 */
STATIC_INLINE LIDARSCAN_time_t LIDARSCAN_get_time_remaining( const LIDARSCAN_t * const signal, LIDARSCAN_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t LIDARSCAN_is_new( const LIDARSCAN_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (LIDARSCAN_time_t)0);
}
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @return LIDARSCAN_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE LIDARSCAN_data_t LIDARSCAN_get( const LIDARSCAN_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @param  LIDARSCAN_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t LIDARSCAN_get_with_status( const LIDARSCAN_t * const signal
                                           ,       LIDARSCAN_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @param  LIDARSCAN_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_set(       LIDARSCAN_t * const signal
                           , const LIDARSCAN_data_t value  )
{
   ...
   //Increment the age
   //LIDARSCAN_inc_age(signal); //Taken out to support time triggered increment of age
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @return LIDARSCAN_raw_t: current value of the raw data buffer
 */
STATIC_INLINE LIDARSCAN_raw_t LIDARSCAN_get_raw( const LIDARSCAN_t * const signal )
{                                                                                                                      
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @param  LIDARSCAN_raw_t * const raw_value : Pointer for returning the current value of the raw data buffer
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t LIDARSCAN_get_raw_with_status( const LIDARSCAN_t * const signal
                                               ,       LIDARSCAN_raw_t * const raw_value )
{                                                                                                                      
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @param const LIDARSCAN_raw_t raw_value: Raw value which will be stored in the daw data buffer. The application value will be updated afterwards
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t LIDARSCAN_set_raw(       LIDARSCAN_t * const signal
                               , const LIDARSCAN_raw_t         raw_value )
{
   ...
   //LIDARSCAN_data_t value = signal->value;
 ...
 *
 */
STATIC_INLINE RC_t LIDARSCAN_refresh( LIDARSCAN_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {                                                                                                                   
      //LIDARSCAN_raw_t raw_value  = signal->raw_value; // Todo: Critical section for complex datatypes.
      if ( ! signal->discon_raw_value )
	  {
 ...
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_flush( const LIDARSCAN_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const LIDARSCAN_flush_channel_t * p_flush_channel =
                                            (const LIDARSCAN_flush_channel_t *)(signal->p_sig_cfg->p_flush_channel_table);
         
   if ( ! signal->discon_raw_value )	 
   {
	   // Only flush in case the raw value is not disconnected.
	   
       if ( ! LIDARSCAN_is_status_invalid( signal ) )
	   {                                                                                                                   
		  ...
		  {                                                                                                                
			 while ( NULL != p_flush_channel->flush_func )                                                                 
			 {
				...
				if ( p_flush_channel->flush_func( (const LIDARSCAN_raw_t * const)&(signal->raw_value)
 ...
 *
 * @param LIDARSCAN_t * const signal: Pointer to the signal object
 * @param LIDARSCAN_data_t * const value: Pointer for returning the application value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_read( LIDARSCAN_t * const signal
                            ,     LIDARSCAN_data_t * const value  )
{                                                                                                                      
   RC_t ret = LIDARSCAN_refresh( signal );
   *value = LIDARSCAN_get( signal );
   return ret;                                                                                                         
}
 ...
 *
 * @param  LIDARSCAN_t * const signal: Pointer to the signal object
 * @return LIDARSCAN_data_t* const: pointer to current value of the application data buffer
 *
 **/
STATIC_INLINE LIDARSCAN_data_t* const LIDARSCAN_get_by_pointer( const LIDARSCAN_t * const signal )
{                                                                                                                      
   return (LIDARSCAN_data_t* const) &(signal->value);                                                                                               
}                                                                                                                       
 ...
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_read_with_status(  LIDARSCAN_t * const signal
                                     , LIDARSCAN_data_t * const value
                                     , sig_sts_t* const status    )
{                                                                                                                      
   RC_t ret = LIDARSCAN_refresh( signal );
   *status   = LIDARSCAN_get_with_status( signal, value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param LIDARSCAN_t * const signal: Pointer to the signal object
 * @param LIDARSCAN_raw_t * const raw_value: Pointer for returning the raw data value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_read_raw( LIDARSCAN_t * const signal
                                , LIDARSCAN_raw_t * const raw_value )
{                                                                                                                      
   RC_t ret     = LIDARSCAN_refresh( signal );
   *raw_value = LIDARSCAN_get_raw( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_read_raw_with_status(  LIDARSCAN_t * const signal
                                         ,  LIDARSCAN_raw_t * const raw_value
                                         , sig_sts_t* const status       )
{                                                                                                                      
   RC_t ret = LIDARSCAN_refresh( signal );
   *status   = LIDARSCAN_get_raw_with_status( signal, raw_value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param LIDARSCAN_t * const signal: Pointer to the signal object
 * @param const LIDARSCAN_data_t value: The new value for the application data buffer
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t LIDARSCAN_write(       LIDARSCAN_t * const signal
                             , const LIDARSCAN_data_t             value  )
{                                                                                                                      
   RC_t ret = LIDARSCAN_set( signal, value );
                                                                                                                       
   if ( ret == RC_SUCCESS )                                                                                            
   {                                                                                                                   
      ret = LIDARSCAN_flush( signal );
   }                                                                                                                   
 ...
 *
 * @param LIDARSCAN_t * const signal: Pointer to the signal object
 * @param const LIDARSCAN_raw_t raw_value: new raw value
 * @return  RC_t: Return value of the driver call
 *
 */
STATIC_INLINE RC_t LIDARSCAN_write_raw(       LIDARSCAN_t * const signal
                                 , const LIDARSCAN_raw_t         raw_value )
{                                                                                                                      
   RC_t ret = LIDARSCAN_set_raw( signal, raw_value );
 ...
 *
 * @param LIDARSCAN_t * const * const p_signal_list: Pointer to the signal list
 * @return RC_t: RC_SUCCESS if all calls have been successful, RC_ERROR otherwise
 */
STATIC_INLINE RC_t LIDARSCAN_refresh_all( LIDARSCAN_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   LIDARSCAN_t * const * p_elem = (LIDARSCAN_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {                                                                                                                   
      if ( LIDARSCAN_refresh( (LIDARSCAN_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
 ...
 *
 */
STATIC_INLINE RC_t LIDARSCAN_flush_all( LIDARSCAN_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const LIDARSCAN_t * const * p_elem = (const LIDARSCAN_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {
	   //Todo: add other return code error handling
      if ( LIDARSCAN_flush( (const LIDARSCAN_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
...
*
*/
#define LIDARSCAN_CREATE_SIGNAL(																	    \
                           SIGNAL_NAME																\
                         , INIT_VALUE                                                               \
                         , INIT_RAW_VALUE                                                           \
                         , SCL_RAW_TO_VAL                                                           \
						 ...
						 , MEMROM)																	\
                                                                                                    \
static const LIDARSCAN_cfg_t SIGNAL_NAME##_cfg __attribute__ ((section ( #MEMROM )))=				    \
{                                                                                                   \
   SCL_RAW_TO_VAL,                                                                                  \
   SCL_VAL_TO_RAW,                                                                                  \
   REFRESH_IDX,                                                                                     \
   ...
   FLUSH_CHANNEL_TABLE                                                                              \
																									...
																									\
LIDARSCAN_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   INIT_RAW_VALUE,                                                                                  \
   SIG_STS_STARTUP,                                                                                 \
