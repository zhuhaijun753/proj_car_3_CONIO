...
extern "C"
{
    ...
    typedef struct PxInfoTask_t
    {
        ...
        PxInfoTaskState_t PxInfoTask_State;
    ...
    typedef struct
    {
        PxInfoMsgType_t PxInfoMsg_Type;
    ...
    typedef struct
    {
        PxInfoOpoolType_t PxInfoOpool_Type;
    ...
    typedef struct
    {
        PxInfoDelayType_t PxInfoDelay_Type;
