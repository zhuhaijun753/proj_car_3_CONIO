 ...
 *
 *	Changelog:
 *	- 0.4 07.05.17 Rahul Raj
 *		- Added QSPI defines for TC29xB
 *  - 0.3 12.01.17  Barth
...
#define TARGET_ID   			    TARGET_AURIX_TC29xB
...
// ------ [ AURIX ]
	...
	#define DERIVATE_NUM_CORES				3
	#define DERIVATE_NUM_PINS				276
	#define DERIVATE_NUM_CAN_N				4
	#define DERIVATE_NUM_CAN_OBJ			256
	#define DERIVATE_NUM_CAN_LST			16
	#define DERIVATE_QSPI_NUM_MOD			6
	#define DERIVATE_QSPI_NUM_CHAN_PER_MOD 	16
	#define DERIVATE_QSPI_NUM_ECON_PER_MOD	8
	#define	DERIVATE_QSPI_HW_FIFO_DEPTH		4
