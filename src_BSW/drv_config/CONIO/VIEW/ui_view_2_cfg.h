 ...
 */
#ifndef SRC_ASW_UI_VIEW_2_CFG_H_
#define SRC_ASW_UI_VIEW_2_CFG_H_
...
#define UI_CAR_STATE_DET_ENTRIES			(4)
#elif ((CONIO_MODE == CONIO_REV_PORTRAIT) || (CONIO_MODE == CONIO_PORTRAIT))
#define UI_CAR_STATE_DET_ENTRIES			(6)
#endif
...
{
	CONIO_TEXT_t	mValTS;
	CONIO_TEXT_t	mValCore;
	CONIO_TEXT_t	mValStr;
}UI_DET_cfg_t;

#endif /* SRC_ASW_UI_VIEW_2_CFG_H_ */
